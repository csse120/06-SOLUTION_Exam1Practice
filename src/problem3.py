...
def test_problem3a():
    ...
    # Window 4:
    title = 'Problem 3a. Test 5: Start at (30, 30), 8 lines.'
...
def problem3a(window, point, n):
    ...
    for _ in range(n):
        ...
        # Alternative to the above (OK because Line CLONES its points).
#         top_point_of_line.move_by(20, 10)
#         bottom_point_of_line.move_by(20, 10)
...
def problem3b(m, point1):
    ...
    # Students don't need a fancy title like this:
