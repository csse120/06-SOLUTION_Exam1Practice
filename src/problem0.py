...
def is_prime(n):
    ...
    return True  #
    # ------------------------------------------------------------------  #
    # Students:  #   Do NOT touch the above  is_prime  function - it has no
    # TO DO.  #   Do NOT copy code from this function.  #  # Instead, ** CALL
    #  ** this function as needed in the problems below.  #
    # ------------------------------------------------------------------
